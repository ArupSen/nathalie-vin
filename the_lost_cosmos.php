...
<div id="carousel-nathalie" class="carousel slide col-lg-offset-1" data-ride="carousel">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active"> <?php img_tag('The-Lost-Cosmos--LARGE-close-up3.jpg'); ?> </div>
    <div class="item"> <?php img_tag('The-Lost-Cosmos-Nathalie-Vin-1c.jpg'); ?> </div>
    <div class="item"> <?php img_tag('The-Lost-Cosmos-Nathalie-Vin-1d.jpg'); ?> </div>
    <div class="item"> <?php img_tag('The-Lost-Cosmos-Nathalie-Vin-1e.jpg'); ?> </div>
    <div class="item"> <?php img_tag('The-Lost-Cosmos-Nathalie-Vin-1f.jpg'); ?> </div>
  </div>
